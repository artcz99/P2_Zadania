...
int main() {
    ...
    cout << "Zadanie 1" << endl;
    cout << "Maksymalna wartosc to: " << max_val(arr, size) << endl;
    cout << endl;

    cout << "Zadanie 2" << endl;
    arr = reverse_array(arr, size);
    cout << "Odwrocona kolejnosc: " << max_val(arr, size) << endl;
    print_arr(arr, size);
    cout << endl;

    cout << "Zadanie 3" << endl;
    int shift;
    cout << "O ile pol w lewo przesunac elementy w tablicy: ";
    cin >> shift;
